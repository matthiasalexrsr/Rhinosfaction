#!/usr/bin/env python3
"""
Reparierte und erweiterte Patient-Management-Tests
...
- Verbesserte Validierungstests
- Erweiterte medizinische Test-Szenarien
- Performance-Tests mit Batch-Operationen
...
class PatientManagerTestSuite:
    """Reparierte und erweiterte Test-Suite für Patient-Management-System"""
    ...
    def create_test_patient(self, patient_id: str, **overrides) -> Patient:
        ...
        # Standardwerte - sicherstellen dass gültige Namen verwendet werden
        defaults = {
            'lastname': 'Testmann',
            'firstname': f'Patient{self.patient_counter}',
            'gender': Gender.MALE,
            'dob': date(1990, 1, 1),
        ...
        # Patient - folder_slug wird aus Demographics generiert
        # Aber wir setzen es explizit, um Pydantic-Validierung zu erfüllen
        temp_demographics = demographics
        birth_date = temp_demographics.dob.strftime('%Y%m%d')
        folder_slug = f"{temp_demographics.lastname}_{temp_demographics.firstname}_Geb{birth_date}__{patient_id}"
    ...
    def test_03_duplicate_patient_creation(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Wir verwenden den gleichen Namen und das gleiche Geburtsdatum
    ...
    def test_04_update_patient(self) -> Dict[str, Any]:
        ...
        try:
            ...
            loaded_patient.surgery.outcomes.complications = ['Mäßige Schwellung']
            ...
            update_verified = (
                ...
                'Mäßige Schwellung' in updated_patient.surgery.outcomes.complications
            )
    ...
    def test_07_realistic_medical_scenarios(self) -> Dict[str, Any]:
        """Test 7: Realistische medizinische Szenarien (10 verschiedene)"""
        ...
        try:
            ...
            # Szenario 3: Komplexer Fall mit Revision
            scenario3 = self.create_test_patient(
                ...
                satisfaction_vas=6,
                complications_postop=['Infektion', 'Asymmetrie'],
                anesthesia=AnesthesiaType.GENERAL,
                op_duration_min=240,
                blood_loss_ml=200
            )
            ...
            # Szenario 8: Revision nach misslungener OP
    ...
    def test_09_error_handling(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Test 3: Versuche ungültigen Ordner-Slug zu verwenden
            try:
                # Erstelle einen Patienten und ändere dann den folder_slug
                patient = self.create_test_patient("error_001")
                success, message, patient_id = patient_manager.create_patient(patient)
                
                if success:
                    # Lade Patient und setze ungültigen folder_slug
                    loaded_patient = patient_manager.get_patient_by_id(patient_id)
                    loaded_patient.folder_slug = "invalid/slug/with/slashes"
                    
                    update_success, update_message = patient_manager.update_patient(loaded_patient)
                    error_tests.append({
                        'test': 'invalid_folder_slug',
                        'correctly_handled': not update_success,
                        'result': 'success' if not update_success else 'error',
            ...
            # Test 4: Unicode-Problem in Namen
            try:
    ...
    def test_10_data_consistency(self) -> Dict[str, Any]:
        ...
        try:
            ...
            patient = self.create_test_patient(
                ...
                op_duration_min=150,
                blood_loss_ml=100,
                complications_postop=['Leichte Schwellung']
            )
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        self.logger.info("Starte umfassende Patient-Management-Tests (Repariert)")
...
def main():
    """Hauptfunktion"""
    print("=" * 80)
    print("REPARIERTE PATIENT-MANAGEMENT-SYSTEM TESTS")
    print("=" * 80)
    ...
    with open('patient_management_test_results.json', 'w', encoding='utf-8') as f:
        json.dump(report, f, indent=2, ensure_ascii=False, default=str)
    
    print(f"\n{'='*80}")
    print(f"Test-Bericht gespeichert in: patient_management_test_results.json")
    print(f"{'='*80}")
